...
import assets from '../src/middleware/routes/assets';
import defaultRoute from '../src/middleware/routes/default';
import meta from '../src/middleware/routes/meta';

const config = {
    isDev: true,
    DEV_PROXY_ENABLED: false,
    PUBLIC_PATH: path.join(__dirname, 'assets'),
...
describe('basics-integration', () => {

    describe('combination of assets, default-route, meta, and error handler should behave as expected', () => {
